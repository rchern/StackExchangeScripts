	...
	*/
	...
	$(function () {
		...
		var selectItem = function (items, i) {
			...
			$.scrollTo((i === 0 ? 0 : selectedItem), { "duration": 2E3 });
		};
		...
		var questionListing = $("#questions").length > 0, curIndex = 0, selectedItem = null;
		if (questionListing) {
			var questions = $("div.question-summary");
			selectItem(questions, curIndex);
